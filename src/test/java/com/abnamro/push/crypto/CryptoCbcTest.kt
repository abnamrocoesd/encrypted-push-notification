...
private const val TRANSACTION = "AES/CBC/PKCS5Padding"
...
class CryptoCbcTest {
    ...
    fun `image encryption`(){
        val dataImage =  File("./src/test/res/cbc/input.bmp").readImage()
        ...
        imageByte.toBitmap(dataImage,"./src/test/res/cbc/output.bmp")
    }
}